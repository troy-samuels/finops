/**
 * Pricing registry for AI models
 * Copied from @costpane/sdk for self-contained operation
 */
 ...
 * Prices sourced from official provider pricing pages (March 2026).
...
/**
 * Get all known providers from the pricing registry.
 * 
